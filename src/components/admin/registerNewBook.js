...
import SmallerGreenButton from '../helpers/smallerGreenButton';
  ...
  function RegisterNewBook(props) {
    ...
    useEffect(() => {
      ...
      axios
      .get('htts://elscanner-backend.herokuapp.com/retrieve-registered-publishers', config)
      .then(response => {
    ...
    const handleSubmit = (event) => {
      ...
      axios
      .post(`htts://elscanner-backend.herokuapp.com/register-new-book/${bookInfo.upc}`, {...bookInfo}, config)
      .then(response => {
        ...
        if (response.data === 'BOOK_REGISTERED') {
          ...
          if (props.userRole === "Student") {
            ...
            axios
            .post("htts://elscanner-backend.herokuapp.com/check-book-out", studentAndBookUPC, config)
