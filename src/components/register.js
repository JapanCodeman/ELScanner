...
function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    if (user.registrationCode === '') {
      const newUser = {...user}
      axios.post('https://elscanner-backend.herokuapp.com/users/register-new-user', newUser)
      .then(response => {
      ...
      const newAdmin = {...user}
      axios.post('https://elscanner-backend.herokuapp.com/users/register-new-admin', newAdmin)
      .then(response => {
